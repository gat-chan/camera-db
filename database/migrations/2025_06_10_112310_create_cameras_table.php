...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('cameras', function (Blueprint $table) {
            ...
            $table->decimal('shutter_electronic_min', 10, 3)->nullable();
            $table->decimal('shutter_electronic_max', 10, 10)->nullable();
            $table->decimal('shutter_mechanical_min', 10, 3)->nullable();
            ...
            $table->decimal('operating_temp_min_c', 5, 2)->nullable();
            $table->decimal('operating_temp_max_c', 5, 2)->nullable();
            $table->decimal('body_width')->nullable();
            $table->decimal('body_height')->nullable();
            $table->decimal('body_depth')->nullable();
            $table->decimal('body_weight_g', 6, 2)->nullable();
            $table->decimal('body_total_weight_g', 6, 2)->nullable();
